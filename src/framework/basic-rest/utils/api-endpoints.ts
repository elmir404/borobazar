export const API_ENDPOINTS = {
  ...
  CATEGORIES: '/api/Category/GetInPowerCategories',
  DIETARY: '/dietary.json',
  BRANDS: '/brands.json',
  PRODUCTS: '/api/Product/GetInPowerProducts',
  PRODUCT: 'api/Product/GetProduct',
  ...
  SEARCH: 'api/Product/SearchProduct',
  ORDERS: '/orders.json',
  ORDER: '/order.json',
  ...
  ADDPRODUCT:'api/Product/SendProductRequest'
};
